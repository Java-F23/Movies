...
public class testdata extends Movies {
    public Movie movie1;
    public Movie movie2;
    public Movie movie3;
    public Movie movie4;
    ...
    public ArrayList<String> screenings = new ArrayList<>();
    ...
    String review;
    public testdata(){
        screenings.add(TheaterA);
        screenings.add(TheaterB);
        screenings.add(TheaterC);
        ...
        movie2 = new Movie("Inception", 2010, "Sci-fi", cast2, "Inception is a 2010 science fiction thriller directed by Christopher Nolan. The film revolves around the concept of shared dreaming and follows a skilled thief named Dom Cobb (played by Leonardo DiCaprio) who specializes in a form of corporate espionage that involves entering the dreams of others to steal their secrets.", timings1, screenings);
        cast3.add("Tom Hanks");
        cast3.add("Robin Wright");
        cast3.add("Gary Sinise");
        movie3 = new Movie("Forrest Gump", 1994, "Drama", cast3, "Forrest Gump is a 1994 film directed by Robert Zemeckis. The story is narrated by Forrest Gump (played by Tom Hanks), a man with low intelligence but a kind heart, as he recounts his extraordinary life experiences.", timings1, screenings);
        cast4.add("Harrison Ford");
        cast4.add("Karen Allen");
        cast4.add("Paul Freeman");
        movie4 = new Movie("Raiders of The Lost Ark", 1981, "Action", cast4,"Raiders of the Lost Ark is a 1981 action-adventure film directed by Steven Spielberg and produced by George Lucas. The movie follows the iconic archaeologist and adventurer, Dr. Indiana Jones (played by Harrison Ford), in his quest to find the Ark of the Covenant, an ancient biblical artifact believed to possess extraordinary power.", timings1, screenings);
        cast5.add("Christian Bale");
        cast5.add("Heath Ledger");
        cast5.add("Aaron Eckhart");
        movie5 = new Movie("The Dark Knight", 2008, "Action", cast5, "The Dark Knight is a 2008 superhero film directed by Christopher Nolan and is the second installment of Nolan's Batman trilogy. The film follows the journey of Gotham City's vigilante, Batman, as he faces one of his most formidable adversaries, the Joker.", timings2, screenings);
        cast6.add("Tim Robbins");
        cast6.add("Morgan Freeman");
        cast6.add("Bob Gunto");
        movie6 = new Movie("Shawshank Redemption", 1994, "Drama", cast6, "The Shawshank Redemption is a 1994 drama film directed by Frank Darabont, based on a novella by Stephen King. The story revolves around Andy Dufresne, a banker who is wrongfully convicted of the murder of his wife and her lover and is sentenced to life in Shawshank State Penitentiary.", timings2, screenings);
        ...
        movie8 = new Movie("Pulp Fiction", 1994, "Action", cast8, "Pulp Fiction is a 1994 neo-noir crime film directed by Quentin Tarantino. The story is told in a non-linear narrative style and follows various interconnected characters through a series of interlocking crime stories in Los Angeles.", timings3, screenings);
        cast9.add("Jonah Hill");
        cast9.add("Micheal Cera");
        cast9.add("Christopher Mintz-Plasse");
        movie9 = new Movie("Superbad", 2007 , "Comedy", cast9, "Superbad follows two high school friends, Seth and Evan, who embark on a quest to obtain alcohol for a party to impress their crushes. Along the way, they encounter various hilarious misadventures and learn important lessons about friendship and growing up.", timings1, screenings);
        cast10.add("Ralph Fiennes");
        cast10.add("Tony Revolori");
        cast10.add("Adrien Brody");
        movie10 = new Movie("The Grand Budapest Hotel", 2014 , "Comedy", cast10, "The Grand Budapest Hotel is a quirky comedy that takes place in the fictional European hotel between the wars. The film revolves around the misadventures of Gustave H., the hotel's legendary concierge, and Zero Moustafa, a young lobby boy, as they become embroiled in a plot involving theft, murder, and a valuable painting.", timings3, screenings);
